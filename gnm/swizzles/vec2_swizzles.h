...
#define GNM_SWIZZLE_VEC2_T_2_X(T, X, P0, C0, T0) \
  GNM_SWIZZLE_T_2(T, 2, X, 0, P0##x, C0##r, T0##s) \
  GNM_SWIZZLE_T_2(T, 2, X, 1, P0##y, C0##g, T0##t)
...
#define GNM_SWIZZLE_VEC2_T_3_XY(T, X, Y, P0, P1, C0, C1, T0, T1) \
  GNM_SWIZZLE_T_3(T, 2, X, Y, 0, P0##P1##x, C0##C1##r, T0##T1##s) \
  GNM_SWIZZLE_T_3(T, 2, X, Y, 1, P0##P1##y, C0##C1##g, T0##T1##t)
...
#define GNM_SWIZZLE_VEC2_T_4_XYZ(T, X, Y, Z, P0, P1, P2, C0, C1, C2, T0, T1, T2) \
  GNM_SWIZZLE_T_4(T, 2, X, Y, Z, 0, P0##P1##P2##x, C0##C1##C2##r, T0##T1##T2##s) \
  GNM_SWIZZLE_T_4(T, 2, X, Y, Z, 1, P0##P1##P2##y, C0##C1##C2##g, T0##T1##T2##t)
